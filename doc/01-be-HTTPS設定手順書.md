...
詳細な環境変数設定については [02.env-file-setup.md](./02.env-file-setup.md) を参照してください。
...
#### 接続確認
- **PC**: `https://localhost:8080`
- **スマホ**: `https://192.168.10.50:8080`
...
# 学生情報取得（例）
curl -k https://localhost:8080/api/v1/students/1

# レクリエーション一覧取得
curl -k https://localhost:8080/api/v1/recreations
```
